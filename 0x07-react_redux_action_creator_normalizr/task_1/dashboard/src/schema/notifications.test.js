...
describe('Notification Tests', () => {
  it('should fetch user notifications from JSON data', () => {
    ...
    const notifications = fetchUserNotifications('5debd764a7c57c7839d722e9');

    expect(notifications).toEqual(expect.arrayContaining(expectedNotifications));
  });

  it('should match the normalized result array', () => {
    ...
    const normalizedResult = normalizedData.result;

    expect(normalizedResult).toEqual(expect.arrayContaining(expectedResult));
  });

  it('should match the normalized user data', () => {
    const expectedUser = {
      age: 25,
  ...
  it('should match the normalized message data', () => {
  ...
  it('should match the normalized notification data', () => {
